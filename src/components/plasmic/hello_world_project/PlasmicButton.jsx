...
import sty from "./PlasmicButton.module.css"; // plasmic-import: -YA3oXbgpP1/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: fASp_0DVmwH/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: Z7Bm84JLeTh/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg___7SFtO)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__qY2H)}
                role={"img"}
              />
            ),
